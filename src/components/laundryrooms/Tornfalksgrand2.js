                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="form-check form-check-inline">
                                <input name="tornfalksgrand2_booked" class="form-check-input" type="checkbox" id="tornfalksgrand2_booked" value="tornfalksgrand2_booked">
                                <label class="form-check-label" for="tornfalksgrand2_booked">BOKAD</label>
                            </div>
                        </div>
                    </div>
                </div>
