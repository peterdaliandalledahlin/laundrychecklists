const AlertKorsangen75 = () => {
	const template = `
        <div class="alert alert-success" role="alert" id="korsangen75_success">
        ...
        <div class="alert alert-danger" role="alert" id="korsangen75_danger">
...
export default AlertKorsangen75;