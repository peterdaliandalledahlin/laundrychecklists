const AlertOrmvraksgrand6 = () => {
	const template = `
        <div class="alert alert-success" role="alert" id="ormvraksgrand6_success">
            <h4 class="alert-heading">Bra gjort!</h4>
            <p>Nu kan du fortsätta till Ormvråksgränd 8.</p>
            <hr>
            <p class="mb-0">Är det något du undrar över kan du alltid ringa Dalle 070-XXX XX XX eller Annett 070-XXX XX XX.</p>
        </div>
        <div class="alert alert-danger" role="alert" id="ormvraksgrand6_danger">
...
export default AlertOrmvraksgrand6;